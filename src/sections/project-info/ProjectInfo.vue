  ...
  <section>
    <div class="mt-12 max-w-full mx-auto px-6 text-center">
      ...
      <p class="text-lg leading-relaxed mb-6">
        ...
        é estar no parque e como é estar nos brinquedos.
      </p>

      <p class="text-lg leading-relaxed mb-6">
        Recomendo que você assista os vídeos das atrações antes de ir para o
        parque, podendo assim evitar más experiências.
      </p>
